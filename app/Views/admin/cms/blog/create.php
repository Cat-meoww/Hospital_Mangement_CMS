...
<form action="<?= base_url("api/admin/cms/blog/create") ?>" method="post" data-reload="true" data-success-redirect="<?= base_url("admin/cms-page/blog") ?>" autocomplete="off" class="grid grid-cols-1 gap-3 fetch-form">
        ...
        <div class="bg-lightwhite dark:bg-white/5 rounded-2xl p-6">
            ...
            <div class=" grid grid-flow-row gap-4">
                <div class="relative bg-white dark:bg-white/5 py-4 px-5 rounded-lg border border-black/10 dark:border-white/10">
                    ...
                    <input required type="text" name="slug" placeholder="... Type" class="form-input">
                </div>
                <div class="relative bg-white dark:bg-white/5 py-4 px-5 rounded-lg border border-black/10 dark:border-white/10">
                    <label class="block text-xs text-black/40 dark:text-white/40 mb-1">Meta Title</label>
                    <input required type="text" name="meta_title" placeholder="... Type" class="form-input">
                </div>
                <div class="relative bg-white dark:bg-white/5 py-4 px-5 rounded-lg border border-black/10 dark:border-white/10">
                    <label class="block text-xs text-black/40 dark:text-white/40 mb-1">Meta Description</label>
                    <input required type="text" name="meta_description" placeholder="... Type" class="form-input">
                </div>
            </div>
        </div>
        <div class="bg-lightwhite dark:bg-white/5 rounded-2xl p-6">
            ...
            <div class=" grid grid-flow-row gap-4 text-black">
                <div class="relative bg-white dark:bg-white/5 py-4 px-5 rounded-lg border border-black/10 dark:border-white/10">
                    ...
                    <input required type="text" name="cms_heading" placeholder="... Type" class="form-input">
                </div>
                <div class="relative bg-white dark:bg-white/5 py-4 px-5 rounded-lg border border-black/10 dark:border-white/10">
                    <label class="block text-xs text-black/40 dark:text-white/40 mb-1">Display Image</label>
                    <input required type="file" accept="image/*" require name="hero_image" class="form-input">
                </div>
