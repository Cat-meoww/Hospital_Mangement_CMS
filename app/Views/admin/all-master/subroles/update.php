...
<form action="<?= base_url("api/admin/all-master/sub-roles/update") ?>" method="post" data-reload="true" autocomplete="off" class="grid grid-cols-1 gap-3 fetch-form">
        ...
        <div class="bg-lightwhite dark:bg-white/5 rounded-2xl p-6">
            ...
            <div class=" grid grid-flow-row gap-4">
                ...
                <div class="relative bg-white dark:bg-white/5 py-4 px-5 rounded-lg border border-black/10 dark:border-white/10">
                    ...
                    <input required type="text" name="name" value="<?= $item->name ?>" placeholder="... Type" class="form-input">
                </div>
                <div class="relative bg-white dark:bg-white/5 py-4 px-5 rounded-lg border border-black/10 dark:border-white/10">
                    <label class="block text-xs text-black/40 dark:text-white/40 mb-1">Role Description</label>
                    <input required type="text" name="description" value="<?= $item->description ?>" placeholder="... Type" class="form-input">
                </div>
            </div>
        </div>
