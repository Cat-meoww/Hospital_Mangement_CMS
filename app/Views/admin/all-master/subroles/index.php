...
<div class="grid grid-cols-1 gap-7">
    <div class="flex gap-3 justify-end">
        ...
        <div class="flex items-center ">
            <a href="<?= base_url('admin/all-master/sub-roles/create') ?>" role="button" title="Create Event" class="btn text-black dark:text-white border hover:bg-indigo-300 dark:hover:bg-indigo-300 border-indigo-300 bg-transparent hover:text-black" @click="toggle">
                Create Role
            </a>
        </div>
    ...
    <?php if (count($Dataset) == 0) : ?>
        <div class="border border-black/10 dark:border-white/10 p-5 flex justify-center items-center rounded-md">
            <div>
                <p class="text-sm font-semibold">No Roles</p>
            </div>
        </div>
    <?php else : ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex gap-1 flex-row justify-center" data-id="<?= $item->id ?>">
                                        ...
                                        <a role="button" title="permissions" href="<?= base_url('admin/all-master/role-permissions/' . $item->id) ?>" class="p-1 text-black dark:text-white">
                                        ...
                                        <a role="button" title="Edit cms" href="<?= base_url('admin/all-master/sub-roles/update/' . $item->id) ?>" class="p-1 text-black dark:text-white">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 256 256">
    ...
    <div class="modal-dialog flex items-center justify-center min-h-screen px-4">
        <div class="modal-content bg-white dark:bg-black relative shadow-3xl border-0 p-0 rounded-lg overflow-hidden w-full max-w-lg my-8">
            <div class="modal-header flex bg-white dark:bg-black border-b border-black/10 dark:border-white/10 items-center justify-between px-5 py-3">
                <h5 class="font-semibold text-lg">Delete Role</h5>
            ...
            <div class="modal-body p-5">
                <form action="<?= base_url("api/admin/all-master/sub-roles/delete") ?>" method="post" data-reload="true" class="flex  flex-col fetch-form" enctype="multipart/form-data">
