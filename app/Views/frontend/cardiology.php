              ...
              <div class="department-panel" data-hover="">
                <div class="department-panel-holder">
                  <div class="department-content"> 
                    ...
                    <div class="department-more" style="color: black;font-size:16px;"><strong>Anupama Balajee</strong></a></div>
                  </div>
                  <!-- End .team-img-->
                  <!-- End .team-content -->
                </div>
              ...
              <div class="department-panel" data-hover="">
                <div class="department-panel-holder">
                  <div class="department-content"> 
                    ...
                    <div class="department-more"  style="color: black;font-size:16px;"><strong>Vidya Nagasubramanian</strong></div>
                  </div>
                  <!-- End .team-img-->
                  <!-- End .team-content -->
                </div>
