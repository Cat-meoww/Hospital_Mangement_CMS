    ...
    <div class="hero-content">
      <div class="row">
        <div class="col-12 col-lg-5">
          ...
          <p class="hero-desc"></p>
          <!----<div class="hero-action"> <a class="btn btn--white btn-line btn-line-after btn-line-inversed" href="javascript:void(0)"> <span>find a doctor</span><span class="line"><span></span></span></a><a class="btn btn--transparent btn-line btn-line-after" href="javascript:void(0)"> <span>our core values</span><span class="line"><span></span></span></a></div>--->
        </div>
          ...
          <div class="service-panel-holder">
            <div class="service-content">
              <div class="service-title">
                <h4><a href="javascript:void(0)">April 2023</a></h4>
              </div>
              <div class="service-desc">
                <p>Bio Medical Waste Report for the month of April 2023</p>
              </div>
              <div class="service-more"><a class="btn btn--white btn-line btn-line-before btn-line-inversed" href="javascript:void(0)"> <span class="line"> <span></span></span><span>View Report</span></a></div>
            </div>
            <!-- End .service-content -->
          </div>
      ...
      <div class=" col-12 col-md-6 col-lg-4">
        <div class="service-panel service-panel-2" data-hover="">
          <div class="service-panel-holder">
            <div class="service-content">
              <div class="service-title">
                <h4><a href="javascript:void(0)">May 2023</a></h4>
              </div>
              <div class="service-desc">
      ...
      <div class=" col-12 col-md-6 col-lg-4">
        <div class="service-panel service-panel-2" data-hover="">
          <div class="service-panel-holder">
            <div class="service-content">
              <div class="service-title">
                <h4><a href="javascript:void(0)">June 2023</a></h4>
              </div>
              <div class="service-desc">
