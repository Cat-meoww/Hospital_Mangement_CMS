            ...
            <div class="title">
              <div class="title-card"  style="margin-top: -180px ;">
                ...
                <div class="title-sub-heading">
                  ...
                  <p>Gem being the centre of excellence for minimally invasive surgery extends care to all the women starting with basic screening to high end surgeries for malignancies with the state of the art technologies in laparoscopy and robotics.</p>
                </div>
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="">Home</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Endogynecology</li>
                </ol>
              </div>
            </div>
            <!-- End .title -->
              ...
              <div class="row">
                <div class="col-12 col-lg-8">
                  <div class="video video-2 bg-overlay bg-overlay-video" id="video-2">
                    <div class="bg-section"><img   src="<?= base_url('frontend/assets/images/video/9.png') ?>" alt="background" /></div>
                  ...
                  <p class="desc">
                   Gem Evecare is one among the top notched centers in our country to perform all Laparoscopic and Robotic Gynaecological procedures including basic and advanced Laparoscopic surgeries for malignancy, severe endometriosis as well. </p>
				   <p class="desc">We treat both benign and malignant gynecological conditions. The department has numerous accolades in treating patients with 
				   </p>
                    <p class="desc">&bull; Large Fibroid uterus (around 6 kg) through Laparoscopy</p>
                    <p class="desc">&bull; Large ovarian cyst (completely occupying the abdomen)</p>
                    <p class="desc">&bull; Complete relief of Endometriosis in grade 4 pelvic endometriosis</p>
					 <p class="desc">&bull; Laparoscopic or Robotic surgeries for prolapse uterus/ recurrent prolapse</p>
                  ...
                  <p class="desc">for operating the patients in the super obese range, or patients with multiple previous surgeries with mesh repair, and with dense adhesions. Patients with urinary incontinence have been surgically helped.
                  ...
                  <p class="desc">Robotic and Laparoscopic lymphadenectomies are offered. Frozen section options and  Radical hysterectomies are also performed in our centre with good results of gynecological surgery.
                  </p>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-12 col-lg-6">
                    ...
                    <ul class="list-unstyled advantages">
                      <li><i class="fas fa-check"></i> Fibroid Uterus</li>
                      <li><i class="fas fa-check"></i> Uterus Preserving Surgeries</li>
                      <li><i class="fas fa-check"></i> Heavy Bleeding During Periods</li>
                      <li><i class="fas fa-check"></i> Endometriosis</li>
					  <li><i class="fas fa-check"></i> Infertility</li>
                      <li><i class="fas fa-check"></i> Ovarian Cyst</li>
                      <li><i class="fas fa-check"></i> Urogynaecology and Gynaecological Malignancies</li>
                      <li><i class="fas fa-check"></i> Rectovaginal Fistula Repair</li>
					  <li><i class="fas fa-check"></i> Pelvic Congestion Syndrome</li>
                      <li><i class="fas fa-check"></i> Laparoscopic Tubal Reanastomosis</li>
                      <li><i class="fas fa-check"></i> Pelvic organ prolapse</li>
                      <li><i class="fas fa-check"></i> Stress incontinence</li><br><br>
                    </ul>
                  </div>
                  <div class="col-12 col-lg-6">
                    ...
                    <ul class="list-unstyled advantages">
                      <li><i class="fas fa-check"></i> Adolescent health care</li>
                      <li><i class="fas fa-check"></i> Reproductive health care</li>
                      <li><i class="fas fa-check"></i> Cancer screening</li>
                      <li><i class="fas fa-check"></i> Menopause clinic</li>
					  <li><i class="fas fa-check"></i> Laparoscopic surgeries</li>
                      <li><i class="fas fa-check"></i> Robotic surgeries</li>
                      <li><i class="fas fa-check"></i> Hysteroscopic procedures</li>
                      <li><i class="fas fa-check"></i> Infertility evaluation</li>
					  <li><i class="fas fa-check"></i> Oncology</li>
                      <li><i class="fas fa-check"></i> Vaginal procedures</li>
                    </ul>
              ...
              <div class="row">
                <div class="col-12 col-md-6">
                  <div class="entry-value"><i class=""></i>
                    <div class="entry-content">
                      ...
                      <p>15,000+ Successful Hysterectomies performed</p>
                ...
                <div class="col-12 col-md-6">
                  <div class="entry-value"><i class=""></i>
                    <div class="entry-content">
                      ...
                      <p>1st time in India Minimally Invasive Paravaginal repair</p>
                ...
                <div class="col-12 col-md-6">
                  <div class="entry-value"><i class=""></i>
                    <div class="entry-content">
                      ...
                      <p>15 Total Laparoscopic Hysterectomies in Uterus > 3Kgs</p>
                ...
                <div class="col-12 col-md-6">
                  <div class="entry-value"><i class=""></i>
                    <div class="entry-content">
                      <!---<h5>Research Pros</h5>--->
                      <p>Performed more than 2000 advanced Laparoscopic procedures</p>
                ...
                <div class="col-12 col-md-6">
                  <div class="entry-value"><i class=""></i>
                    <div class="entry-content">
                      <!---<h5>Emergency 24/7</h5>---->
                      <p>In 1997 1st Center Single Incision Total Lap Hysterectomy & Myomectomy</p>
                      <!---<p>Contact our reception with any medical enquiry for low cost coverage adults.</p>--->
                    </div>
                  </div>
                </div>
                <div class="col-12 col-md-6">
                  <div class="entry-value"><i class=""></i>
                    <div class="entry-content">
                      <!---<h5>Emergency 24/7</h5>---->
                      <p>20K+ Gynecology Laparoscopic surgeries</p>
                      <!---<p>Contact our reception with any medical enquiry for low cost coverage adults.</p>--->
                    </div>
                  </div>
                </div>
                <div class="col-12 col-md-6">
                  <div class="entry-value"><i class=""></i>
                    <div class="entry-content">
                      <!---<h5>Emergency 24/7</h5>---->
                      <p>1st Morcellation in SILS Myomectomy without additional port</p>
                      <!---<p>Contact our reception with any medical enquiry for low cost coverage adults.</p>--->
                    </div>
                  </div>
                </div>
                <div class="col-12 col-md-6">
                  <div class="entry-value"><i class=""></i>
                    <div class="entry-content">
                      <!---<h5>Emergency 24/7</h5>---->
                      <p>Only Center with dedicated Dept for Gynecology & Laparoscopy</p>
                      <!---<p>Contact our reception with any medical enquiry for low cost coverage adults.</p>--->
                    </div>
                  </div>
                </div>
                ...
                <div class="department-panel-holder">
                  <div class="department-content"> 
                    ...
                    <div class="department-desc">
                      <p>Excellent treatment given by Dr Kavita yohini madam and Hysterectomy surgery was also done well . Thanks a lot</p>
                    </div>
                    <div class="department-more" style="color: black; font-size:16px;"><strong>Nila Kumaresan</strong></a></div>
                  </div>
                  <!-- End .team-img-->
                  <!-- End .team-content -->
                </div>
              ...
              <div class="department-panel" data-hover="">
                <div class="department-panel-holder">
                  <div class="department-content"> 
                    ...
                    <div class="department-desc">
                      <p>Excellent treatment and caring of patient by Dr. Kavitha yogini, expert in endo  gynecologist. Explaining well about issues and treatment. All staffs and nurse are nice and approchable</p>
                    </div>
                    <div class="department-more"  style="color: black;font-size:16px;"><strong>Sada Pragash Senthil Sadasivam</strong></div>
                  </div>
                  <!-- End .team-img-->
                  <!-- End .team-content -->
                </div>
              ...
              <div class="container">
                ...
                <div class="carousel owl-carousel carousel-dots" data-slide="3" data-slide-rs="2" data-autoplay="true"
                  ...
                  <div class="col-12 col-lg-8">
                    ...
                    <div class="about-img"><img class="img-fluid"   src="<?= base_url('frontend/assets/images/blog/grid/7.jpg') ?>" style="position: relative;"
                  ...
                  <div class="col-12 col-lg-8">
                    <div class="about-img"><img class="img-fluid"  src="<?= base_url('frontend/assets/images/blog/grid/8.jpg') ?>"
                        alt="about Image" /><br><a class=""
                        href="https://www.youtube.com/watch?v=nrJtHemSPW4">  <img src="<?= base_url('frontend/assets/images/favicon/playbutton.png') ?>" style=" width: 20% !important;  position: absolute; left: 25%; bottom: 35%;" class="bn-1"/>
                        </a></div>
                  </div>
                  <div>
                    <div class="col-12 col-lg-8">
                      <div class="about-img"><img class="img-fluid"
                           src="<?= base_url('frontend/assets/images/blog/grid/9.jpg') ?>" alt="about Image" /><br><a
                          class=""
                          href="https://www.youtube.com/watch?v=nrJtHemSPW4">  <img src="<?= base_url('frontend/assets/images/favicon/playbutton.png') ?>" style=" width: 20% !important;  position: absolute; left: 25%; bottom: 35%;" class="bn-1"/>
                          </a></div>
                    </div>
              ...
              <div class="accordion accordion-3" id="accordion03">
                <div class="card">
                  <div class="card-heading"><a class="card-link collapsed" data-hover="" data-bs-toggle="collapse"
                      role="button" aria-expanded="false" aria-controls="collapse01-1" href="#collapse01-1">Can fibroid of more than 10 cm be operated in laparoscopy?</a></div>
                  <div class="collapse" id="collapse01-1" data-bs-parent="#accordion03">
                    <div class="card-body">Yes, we frequently operate on large fibroids of size 10-15 cm and operated as large as 30 cm.</div>
                  </div>
                </div>
                <div class="card">
                  <div class="card-heading"><a class="card-link collapsed" data-hover="" data-bs-toggle="collapse"
                      role="button" aria-expanded="false" aria-controls="collapse01-2" href="#collapse01-2">How many days do I need to rest after surgery? </a></div>
                  <div class="collapse" id="collapse01-2" data-bs-parent="#accordion03">
                    <div class="card-body">A few hours, as minimally invasive surgeries help in faster recovery; with adequate analgesia, patient is ambulated in 4 hours of surgery and routine can be started the very next day.</div>
                  </div>
                </div>
                <div class="card">
                  <div class="card-heading"><a class="card-link  " data-hover="" data-bs-toggle="collapse" role="button"
                      aria-expanded="false" aria-controls="collapse01-3" href="#collapse01-3">Is post-menopausal bleeding normal? </a></div>
                  <div class="collapse show" id="collapse01-3" data-bs-parent="#accordion03">
                    <div class="card-body">No, every postmenopausal needs evaluation.</div>
                  </div>
                </div>
				<div class="card">
                  <div class="card-heading"><a class="card-link  " data-hover="" data-bs-toggle="collapse" role="button"
                      aria-expanded="false" aria-controls="collapse01-3" href="#collapse01-3">Does removing the uterus, makes you gain weight? </a></div>
                  <div class="collapse show" id="collapse01-3" data-bs-parent="#accordion03">
                    <div class="card-body">No, removing uterus does not make you gain weight.</div>
                  </div>
                </div>
				<div class="card">
                  <div class="card-heading"><a class="card-link  " data-hover="" data-bs-toggle="collapse" role="button"
                      aria-expanded="false" aria-controls="collapse01-3" href="#collapse01-3">Does PCOS always require surgery or medication? </a></div>
                  <div class="collapse show" id="collapse01-3" data-bs-parent="#accordion03">
                    <div class="card-body">No, PCOS can be managed initially with lifestyle modification.</div>
                  </div>
                </div>
              </div>
