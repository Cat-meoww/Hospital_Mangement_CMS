          ...
          <div class="contact-body">
            ...
            <form class="contactForm" method="post" action="assets/php/contact.php">
              <div class="row">
                ...
                <div class="col-12">
                  <button id="enq" class="btn btn--primary btn-line btn-line-before btn--block">
                    <span class="line"> <span> </span></span><span>submit request</span>
                  </button>
                </div>
        ...
        <table class="table table-bordered" id="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="contact-th1">8925847515<br>4214325678</td>
      ...
      <div class="col-12 col-lg-6 ">
        <div class="right_side_content contact_list">
          ...
          <p>Address: 45, Pankaja Mills Rd, Palaniappa Nagar,<br> Sowripalayam Pirivu, Ramanathapuram, Coimbatore, Tamil Nadu 641045
            ...
            <br>Email:<a href="#" class="contact-mail1">info@geminstitude.in</a>
          </p>
        </div>
      </div>
      ...
      <div class="col-12 col-lg-6">
        <div class="right_side_content contact_list">
          ...
          <p>Address:632, Poonamallee High Rd,<br> Ayyavoo Colony, Aminjikarai, Chennai, Tamil Nadu 600029
            ...
            <br>Email:<a href="#" class="contact-mail1">gemannanagar@geminstitute.in</a>
          </p>
        </div>
      </div>
      ...
      <div class="col-12 col-lg-6">
        <div class="right_side_content contact_list">
          ...
          <p>Address:315/1 A, 1 B, TKT Mills Bus Stop,Palladam Main Road Chinnakarai,<br> Veerapandi Ring Rd, PO, Tiruppur, Tamil Nadu 641604
            ...
            <br>Phone:<a href="tel:8925847515">+91 89258 47515</a>
            <br>Email:<a href="#" class="contact-mail1">info@geminstitude.in</a>
          </p>
        </div>
      </div>
      ...
      <div class="col-12 col-lg-6">
        <div class="right_side_content contact_list">
          ...
          <p>Address:1, Lawspet Main Road,<br> Pakkamudayanpet, Saram, Puducherry, 605008
            ...
            <br>Email:<a href="#" class="contact-mail1">pondi@geminstitute.in</a>
          </p>
        </div>
      </div>
      ...
      <div class="col-12 col-lg-6">
        <div class="right_side_content contact_list">
          ...
          <p>Address:GEM Hospital and Research Centre
            ...
            <br>Email:<a href="#" class="contact-mail1">gemthrissur@geminstitute.in</a>
          </p>
        </div>
      </div>
