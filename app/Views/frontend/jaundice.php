...
<body class="jaun-body">
    ...
    <section class="slider slider-2" id="slider-2">
        <div class="container-fluid pr-0 pl-0">
            <div class="slider-carousel owl-carousel carousel-navs" data-slide="1" data-slide-rs="1" data-autoplay="true" data-nav="true" data-dots="false" data-space="0" data-loop="false" data-speed="800" data-slider-id="#custom-carousel">
                <!--  Start .slide-->
                                ...
                                <div class="col-12 col-lg-6">
                                    ...
                                    <div class="col-12 chair-bread">
                                        <ol class="breadcrumb d-flex justify-content-center fo-si ">
                                            ...
                                            <li class=""><a href="<?= base_url('services/jaundice-demo') ?>">Jaundice</a></li>
                                        </ol>
                                    </div>
    ...
    <div class="row my-5 position-relative">
        <div class="col-12 col-md-8 jaun-div1">
            <div class="container px-5">
                <div class="entry-introduction">
                    <div class="row ">
                        <div class="col-12 ">
                            ...
                            <p class="desc"> <strong class="jaun-str">Diagnosis:</strong><br> At GEM Hospital, thorough diagnostic assessments, including blood tests and imaging, are conducted to identify the underlying cause of jaundice in our patients </p>
                            <p class="desc"> <strong class="jaun-str">Treatment:</strong><br> Our expert medical team tailors personalized treatment plans, addressing the specific cause of jaundice. Interventions may range from medication to advanced procedures, ensuring optimal care </p>
                            <p class="desc"> <strong class="jaun-str">After Treatment Care:</strong><br> Post-treatment, patients receive comprehensive care at GEM Hospital, including monitoring, follow-up appointments, and guidance on lifestyle adjustments for a smooth recovery from jaundice. </p>
                            <p class="desc"> <strong class="jaun-str">Jaundice Patient Support:</strong><br>GEM Hospital offers ongoing support for jaundice patients, including educational resources, dietary advice, and a dedicated team to address any concerns during the recovery process </p>
                ...
                <section class="blog blog-grid blog-grid-3 gr gr1 jaun-sec1" id="blog-2">
                    ...
                    <div class="entry-introduction">
                        ...
                        <div class="row ">
                            <div class="col-12 ">
                                ...
                                <div>
                                    <img src=" <?= base_url('frontend/assets/images/background/Symtoms-jaundice.png') ?>" alt=" symptoms-of-jaundice" class="mob" />
                                </div><br>
                ...
                <section class="blog blog-grid blog-grid-3 jaun-sec3" id="blog-2">
                    ...
                    <div class="row ">
                        <div class="col-12 ">
                            ...
                            <div>
                                <img src=" <?= base_url('frontend/assets/images/background/Causes-gem-hospitals.png') ?>" alt="causes-of-jaundice" class="mob" />
                            </div><br>
                ...
                <section class="blog blog-grid blog-grid-3 jaun-sec4" id="blog-2">
                    ...
                    <div class="row ">
                        <div class="col-12 ">
                            ...
                            <div>
                                <img src=" <?= base_url('frontend/assets/images/background/Diagonse-jaundice.png') ?>" alt="Diagnosing-Jaundice" class="mob" />
                            </div><br>
                ...
                <section class="blog blog-grid blog-grid-3 jaun-sec5" id="blog-2">
                    ...
                    <div class="row ">
                        <div class="col-12 ">
                            ...
                            <div>
                                <img src=" <?= base_url('frontend/assets/images/background/Treatment-jaundice.png') ?>" alt="treatment-for-jaundice" class="mob" />
                            </div><br>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-12 offset-lg-0">
                            <div class="heading heading-7 text-center">
                                ...
                                <h2 class="heading-title  jaun-head3">Prenatal Care:Your First Defense</h2>
                            </div>
                        </div>
                    </div>
                ...
                <section class="blog blog-grid blog-grid-3 jaun-sec6" id="blog-2">
                    ...
                    <div class="row ">
                        <div class="col-12 ">
                            ...
                            <p class="desc"> Gem hospital provides the most comprehensive jaundice care involving surgeons and physicians</p>

                            <p class="desc"> Usage of advanced gadgets like endoscopic ultrasound , Spyglass to aid better treatment and care</p>
            ...
            <div class="col-12 col-lg-12 position-relative">
                ...
                <div class="entry-infos tips-info heading">
                    ...
                    <div class="accordion accordion-3" id="accordion03">
                        <div class="card">
                            <div class="card-heading"><a class="card-link collapsed" data-hover="" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="collapse01-1" href="#collapse01-1">1. How Long is Jaundice Recovery?</a></div>
                            <div class="collapse" id="collapse01-1" data-bs-parent="#accordion03">
                                <div class="card-body color-heading">Recovery duration varies based on the underlying cause. Mild cases may resolve in a few weeks, while severe cases may require prolonged treatment and monitoring.</div>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-heading"><a class="card-link collapsed" data-hover="" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="collapse01-2" href="#collapse01-2">2. Hospital Stay for Jaundice?</a></div>
                            <div class="collapse" id="collapse01-2" data-bs-parent="#accordion03">
                                <div class="card-body color-heading">Hospitalization duration depends on severity. Mild cases may not require admission, while severe cases need close monitoring and treatment. Consult your healthcare provider for personalized information.</div>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-heading"><a class="card-link  collapsed" data-hover="" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="collapse01-3" href="#collapse01-3">3.Is Ignoring Jaundice Dangerous?</a></div>
                            <div class="collapse" id="collapse01-3" data-bs-parent="#accordion03">
                                <div class="card-body color-heading">Ignoring jaundice can be risky. It may signal underlying health issues, including liver dysfunction. Prompt medical attention is crucial for accurate diagnosis and effective treatment to prevent complications.</div>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-heading"><a class="card-link collapsed" data-hover="" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="collapse01-1" href="#collapse01-4">4. Are there home remedies for managing Jaundice symptoms?</a></div>
                            <div class="collapse" id="collapse01-4" data-bs-parent="#accordion03">
                                <div class="card-body color-heading">While medical treatment is crucial, certain lifestyle changes and dietary adjustments may complement the healing process. Consult your healthcare provider for guidance.

                                </div>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-heading"><a class="card-link collapsed" data-hover="" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="collapse01-1" href="#collapse01-5">5. When to Seek Medical Attention for Jaundice?</a></div>
                            <div class="collapse" id="collapse01-5" data-bs-parent="#accordion03">
                                <div class="card-body color-heading">If you notice yellowing of the skin or eyes, dark urine, or pale stools, consult a healthcare professional promptly. Early detection and intervention improve the chances of successful treatment.</div>
                            </div>
                        </div>
