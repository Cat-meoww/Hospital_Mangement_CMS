...
<section class="page-title page-title-3 bg-overlay bg-overlay-dark bg-parallax" id="page-title">
            ...
            <div class="title">
              <div class="title-card"  style="margin-top: -180px ;">
                ...
                <div class="title-sub-heading">
                  ...
                  <p>The division of colorectal surgery is aiming to offer comprehensive surgical care to patients with benign and malignant diseases of the Colon, Rectum, and Anal canal.</p>
                </div>
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="<?= base_url('')?>">Home</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Colorectal Surgery</li>
                </ol>
              </div>
            </div>
            <!-- End .title -->
        ...
        <div class="row">
          <div class="col-12 col-lg-12">
              ...
              <div class="row">
                <div class="col-12 col-lg-8">
                  <div class="video video-2 bg-overlay bg-overlay-video" id="video-2">
                    <div class="bg-section"><img   src="<?= base_url('frontend/assets/images/video/6.png') ?>" alt="background" /></div>
                  ...
                  <p class="desc">
                    Emergency and Elective procedures pertaining to the</p>
                 
                    <p class="desc">&bull; Colon</p>
                    <p class="desc">&bull; Rectum</p>
                    <p class="desc">&bull; Anus.</p>
                  ...
                  <p class="desc">are performed by a dedicated team of Gastroenterologists specially trained and experienced in Colorectal Surgery. If one would want to name one surgery that’s made open surgery go down the gutter, it’s Laparoscopic Resections of the Colon and Rectum for tumours, IBD, Tuberculosis, etc.
                  ...
                  <p class="desc">With more advanced imaging and technologies like the da Vinci Robotic surgery platform, 4K laparoscopic suite, and 3D imaging in laparoscopy, it has only become better for the patient in terms of outcomes and recovery and to the surgeon in terms of ease and comfort.
                  </p>
				  <p class="desc">Using these technologies and expertise the team has successfully been able to avoid Colostomy/Ileostomy with sphincter preservation for hundreds of patients who otherwise might have needed a colostomy. Over the years, GEM has been honoured as the Best Colorectal Surgery Centre in Coimbatore and Chennai.
                  </p>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-12 col-lg-6">
                    ...
                    <ul class="list-unstyled advantages">
                      <li><i class="fas fa-check"></i> Out-patient clinics</li>
                      <li><i class="fas fa-check"></i> Tumour Board Service</li>
                      <li><i class="fas fa-check"></i> Out-patient procedures</li>
					  <li><i class="fas fa-check"></i> Anal physiology services</li>
                      <li><i class="fas fa-check"></i> Diagnostic services</li>
                      <li><i class="fas fa-check"></i> Therapeutic services</li>
                      <li><i class="fas fa-check"></i> Chemotherapy services</li><br><br>
                    </ul>
                  </div>
                  <div class="col-12 col-lg-6">
                    ...
                    <ul class="list-unstyled advantages">
                      <li><i class="fas fa-check"></i> Cancer Colon</li>
                      <li><i class="fas fa-check"></i> Cancer Rectum</li>
                      <li><i class="fas fa-check"></i> Anal canal Malignancy</li>
                      <li><i class="fas fa-check"></i> Familial Adenomatous polyposis/Inflammatory bowel disease</li>
					  <li><i class="fas fa-check"></i> Perineal procedures</li>
                      <li><i class="fas fa-check"></i> TEM / TAMIS</li>
                    </ul>
            ...
            <div class="entry-infos core-values">
              <h6 class="entry-heading" style=" font-weight: 700; text-align:center;
  font-size: 16px;
  line-height: 27px;
              ...
              <div class="row">
                <div class="col-12 col-md-6">
                  <div class="entry-value"><i class=""></i>
                    <div class="entry-content">
                      ...
                      <p>2000 Lap Anterior Resections & 40 Lap Recto Vaginal Fistula</p>
                ...
                <div class="col-12 col-md-6">
                  <div class="entry-value"><i class=""></i>
                    <div class="entry-content">
                      ...
                      <p>4000 Colectomies & 250 Lap TPC + IPAA</p>
                ...
                <div class="col-12 col-md-6">
                  <div class="entry-value"><i class=""></i>
                    <div class="entry-content">
                      ...
                      <p>80 Parastomal Hernia & 30 Lap Colo Vaginal Fistula</p>
                ...
                <div class="col-12 col-md-6">
                  <div class="entry-value"><i class=""></i>
                    <div class="entry-content">
                      <!---<h5>Research Pros</h5>--->
                      <p>75 Hartmann’s Reversal & 150 Lap Rectopexy</p>
                ...
                <div class="col-12 col-md-6">
                  <div class="entry-value"><i class=""></i>
                    <div class="entry-content">
                      <!---<h5>Emergency 24/7</h5>---->
                      <p>The 40th National Conference of the Association of Colon and Rectal Surgeons of India organised by GEM Hospital</p>
                      <!---<p>Contact our reception with any medical enquiry for low cost coverage adults.</p>--->
                    </div>
                  </div>
                </div>
                <div class="col-12 col-md-6">
                  <div class="entry-value"><i class=""></i>
                    <div class="entry-content">
                      <!---<h5>Emergency 24/7</h5>---->
                      <p>First prize in ACRSICON2018 for experience of 1000 cases of laparoscopic anterior resection at GEM Hospital</p>
                      <!---<p>Contact our reception with any medical enquiry for low cost coverage adults.</p>--->
                    </div>
                  </div>
                </div>
                <div class="col-12 col-md-6">
                  <div class="entry-value"><i class=""></i>
                    <div class="entry-content">
                      <!---<h5>Emergency 24/7</h5>---->
                      <p>The National Conference on Colorectal Surgery ACRSI 2001, organised and successfully conducted by GEM Hospital</p>
                      <!---<p>Contact our reception with any medical enquiry for low cost coverage adults.</p>--->
                    </div>
                  </div>
                </div>
                <div class="col-12 col-md-6">
                  <div class="entry-value"><i class=""></i>
                    <div class="entry-content">
                      <!---<h5>Emergency 24/7</h5>---->
                      <p>International Live Workshop and Conference on Minimally Invasive Colorectal Surgery – COLOREC2013, organised by GEM Hospital</p>
                      <!---<p>Contact our reception with any medical enquiry for low cost coverage adults.</p>--->
                    </div>
                  </div>
                </div>
                ...
                <div class="department-panel-holder">
                  <div class="department-content"> 
                    ...
                    <div class="department-desc">
                      <p>I have under gone hernia surgery which was requiring large size of mesh to be placed. I enquired other hospitals and  I was suggested to go for open surgery only considering the mesh size and complexity of the surgery.  But it is the experience of the doctor and latest facilities available at GEM that such a major operation was carried out with laproscopy only and the recovery was very fast. Thanks  to Dr. Harish kakkilaya.</p>
                    </div>
              ...
              <div class="department-panel" data-hover="">
                <div class="department-panel-holder">
                  <div class="department-content"> 
                    ...
                    <div class="department-desc">
                      <p>Such a wonderful hospital. Doctors,nurses,ward members are very kind towards patients! I got my appendix removed through laprascopic surgery here. It was very successful and I had a speed recovery. Thankful to this hospital. This hospital deserves more than this great achievement 💫!</p>
                    </div>
  ...
  line-height: 55px;
  margin-bottom: 25px;
  font-weight: 500;">Know More about Colorectal Surgeries</h6>
                    </div>
                  </div>
                </div>
				<br>
                ...
                <div class="carousel owl-carousel carousel-dots" data-slide="3" data-slide-rs="2" data-autoplay="true"
                  ...
                  <div class="col-12 col-lg-8">
                    ...
                    <div class="about-img"><img class="img-fluid"   src="<?= base_url('frontend/assets/images/blog/grid/15.jpg') ?>" style="position: relative;"
                  ...
                  <div class="col-12 col-lg-8">
                    <div class="about-img"><img class="img-fluid"   src="<?= base_url('frontend/assets/images/blog/grid/colon2.jpg') ?>"
                        alt="about Image" /><br><a class=""
                        href="https://www.youtube.com/watch?v=nrJtHemSPW4">   <img src="<?= base_url('frontend/assets/images/favicon/playbutton.png') ?>" style=" width: 20% !important;  position: absolute; left: 25%; bottom: 35%;" class="bn-1"/>
                        </a></div>
                  </div>
              ...
              <div class="accordion accordion-3" id="accordion03">
                <div class="card">
                  <div class="card-heading"><a class="card-link collapsed" data-hover="" data-bs-toggle="collapse"
                      role="button" aria-expanded="false" aria-controls="collapse01-1" href="#collapse01-1">Can colorectal diseases be prevented?</a></div>
                  <div class="collapse" id="collapse01-1" data-bs-parent="#accordion03">
                    <div class="card-body">While not all colorectal diseases can be prevented, certain measures can help reduce the risk. This includes maintaining a healthy lifestyle, managing chronic conditions such as high blood pressure and diabetes, undergoing regular screenings for colorectal cancer, and promptly addressing any concerning symptoms or changes in bowel habits.</div>
                  </div>
                </div>
                <div class="card">
                  <div class="card-heading"><a class="card-link collapsed" data-hover="" data-bs-toggle="collapse"
                      role="button" aria-expanded="false" aria-controls="collapse01-2" href="#collapse01-2">How can I maintain colorectal health? </a></div>
                  <div class="collapse" id="collapse01-2" data-bs-parent="#accordion03">
                    <div class="card-body">To maintain colorectal health, it is recommended to follow a balanced diet rich in fiber, fruits, and vegetables, exercise regularly, maintain a healthy weight, avoid smoking and excessive alcohol consumption, stay hydrated, and undergo regular screenings for colorectal cancer as recommended by your healthcare provider.</div>
                  </div>
                </div>
                <div class="card">
                  <div class="card-heading"><a class="card-link  " data-hover="" data-bs-toggle="collapse" role="button"
                      aria-expanded="false" aria-controls="collapse01-3" href="#collapse01-3">What are the symptoms of colorectal diseases?</a></div>
                  <div class="collapse show" id="collapse01-3" data-bs-parent="#accordion03">
                    <div class="card-body">Symptoms can vary depending on the specific disease, but common symptoms may include changes in bowel habits (diarrhea or constipation), rectal bleeding, abdominal pain or cramps, persistent bloating or gas, unexplained weight loss, fatigue, and a feeling of incomplete bowel emptying. It's important to consult a healthcare provider if you experience any persistent or concerning symptoms.</div>
                  </div>
                </div>
				 <div class="card">
                  <div class="card-heading"><a class="card-link  " data-hover="" data-bs-toggle="collapse" role="button"
                      aria-expanded="false" aria-controls="collapse01-3" href="#collapse01-3">How long is the recovery period after colorectal surgery?</a></div>
                  <div class="collapse show" id="collapse01-3" data-bs-parent="#accordion03">
                    <div class="card-body">The recovery period after colorectal surgery varies depending on the specific procedure performed, the patient's overall health, and the presence of any complications. Generally, it may take several weeks to a few months for patients to fully recover. The healthcare team will provide specific post-operative instructions and monitor the healing process.</div>
                  </div>
                </div>
              </div>
