...
<head>
    ...
    <title>Video Consultation Registration</title>
    <meta name="description" content="Appointment Registration ">
</head>
<style>
    a:hover {
                ...
                <table style="background-color: #f2f3f8; max-width:670px; margin:0 auto;" width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <a href="https://gem-dev.verse.net.in/" title="logo" target="_blank">
                                <img width="200" src="https://gem-dev.verse.net.in/frontend/assets/images/favicon/gem1.jpeg"" title=" logo" alt="logo">
                            </a>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" style="max-width:670px; background:#fff; border-radius:3px;-webkit-box-shadow:0 6px 18px 0 rgba(0,0,0,.06);-moz-box-shadow:0 6px 18px 0 rgba(0,0,0,.06);box-shadow:0 6px 18px 0 rgba(0,0,0,.06);padding:0 40px;">
                                ...
                                <tr>
                                    <td style="padding:0 15px; text-align:center;">
                                        <h1 style="color:#1e1e2d; font-weight:400; margin:0;font-size:32px;font-family:'Rubik',sans-serif;">Video Consultation Registration</h1>
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <p style="font-size:14px; color:#455056bd; line-height:18px; margin:0 0 0;">&copy; <strong><?= env('app.name') ?></strong></p>
                        </td>
                    </tr>
                </table>
            </td>
